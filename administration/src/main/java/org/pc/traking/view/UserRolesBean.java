...
import org.pc.traking.model.UserRoles;
...
public class UserRolesBean implements Serializable {
	...
	@PersistenceContext(unitName = "pc-traking-persistence-unit", type = PersistenceContextType.EXTENDED)
	...
	public void paginate() {
		...
		CriteriaQuery<UserRoles> criteria = builder
	...
	public List<UserRoles> getAll() {
		...
		return this.entityManager.createQuery(
				criteria.select(criteria.from(UserRoles.class)))
				.getResultList();
	}
	...
	public Converter getConverter() {
		...
		final UserRolesBean ejbProxy = this.sessionContext
				.getBusinessObject(UserRolesBean.class);
